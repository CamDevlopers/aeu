...
class FCKeditor {
     ...
     *
     */
    public function Create($editorname) {
     ...
     * @return string
     */
    public function CreateHtml($editorname) {
        ...
        if ($this->IsCompatible()) {
            ...
            $Html .= "<input type=\"hidden\" id=\"{$this->InstanceName}\" name=\"editor[]\" value=\"{$HtmlValue}\" style=\"display:none\" />";
