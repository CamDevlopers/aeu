...
<div class="container main">
    <div class="row">
        <h3 class="text-center text-danger">Create News</h3><br/>
        <div class="col-md-10 col-md-offset-1">
            <form class="form-horizontal" action="<?php echo base_url(); ?>manage_news/add_news" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Short English Description : </label>
                    <div class="col-sm-8 col-md-8 col-lg-8">
