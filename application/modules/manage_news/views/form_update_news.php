...
<div class="container main">
    <div class="row">
        <h3 class="text-center text-danger">Edit News</h3><br/>
        <div class="col-md-10 col-md-offset-1">
            <form class="form-horizontal" action="<?php echo base_url(); ?>manage_news/update_news" method="post" enctype="multipart/form-data">
                <?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3 thumbnail">
                        <img src="<?php echo base_url();?>images/thumbnial/<?php echo $value->thumbnial;?>" width="300"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">Thumbnail : </label>
                    <div class="col-sm-8 col-md-8 col-lg-8">
                        <input type="file" name="thumbnial[]" accept="imgage/*">
                    </div>
                ...
                <input type="hidden" name="id" value="<?php echo $value->nid;?>" />
                <div class="form-group">
                    <div class="col-sm-8 col-md-offset-4 col-lg-6 text-right">
                        <a href="<?php echo base_url().'manage_news'?>"><input type="button" value="Cancel" name="cancel" class="btn btn-warning"/></a>
