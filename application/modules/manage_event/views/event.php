...
<div class="container main">
    <div class="row">
        <nav>
            ...
            <a class="padding-right btn btn-info pull-right" href="<?php echo base_url() . 'manage_event/form_add_event'; ?>"><i class="fa fa-pencil"></i> Add new</a>
        ...
        <table id="example" class="table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo base_url();?>images/thumbnial/<?php echo $value->thumbnail;?>" width="100"/></td>
                        <td><?php echo $this->m_sub_categories->get_main_cat($value->cat_id)?$this->m_sub_categories->get_main_cat($value->cat_id):'No set';?></td>
                        <td><a href="<?php echo base_url().'manage_event/form_update_event/'.$value->eid;?>"><i class="fa fa-edit"></i> Edit</a> | <a href="<?php echo base_url().'manage_event/delete_event/'.$value->eid;?>" onclick="return confirm('Do you want to delete ?')"><i class="fa fa-trash-o"></i> Delete</a></td>
